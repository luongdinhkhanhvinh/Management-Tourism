...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>ID Email</b>  <input type="email" name="email" class="form-control" id="email" placeholder=" ID Email đã được đăng ký" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Số điện thoại</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Số điện thoại đã được đăng ký" required="">
	</p> 
