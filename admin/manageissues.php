...
<html>
<head>
<title>TMS | Quản lý các vấn đề</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý các vấn đề</li>
            </ol>
