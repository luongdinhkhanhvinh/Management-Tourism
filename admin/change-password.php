...
<html>
<head>
<title>TMS | Quản lý mật khẩu</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Thông tin <i class="fa fa-angle-right"></i> Đổi mật khẩu</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
	...
	<div class="form-group">
				...
				<button type="submit" name="submit" class="btn-primary btn">Chấp nhận</button>
