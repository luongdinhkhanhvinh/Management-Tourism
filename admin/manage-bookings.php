...
<html>
<head>
<title>TMS |Quản trị đặt chuyến đi </title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý đặt chuyến</li>
            </ol>
...
{
echo "Đã hủy bởi bạn tại " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='u')
{
echo "Đã hủy bởi người dùng là " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Hủy</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có chắc chắc hủy đặt chuyến phải không !')" >Cancel</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt phòng')" >Xác nhận</a></td>
<?php }?>
