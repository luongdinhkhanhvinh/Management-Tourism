...
$query->execute();
$msg="Tạo gói quản trị thành công";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Cập nhật gói hình ảnh </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Hình mới</label>
									<div class="col-sm-8">
