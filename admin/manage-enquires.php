...
<html>
<head>
<title>TMS | Quản trị quản lý đặt chuyến</title>
...
<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có thực sự muốn đọc')" >Đang chờ xử lý</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
