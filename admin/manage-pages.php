...
<html>
<head>
<title>TMS | Quản trị tạo gói</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Cập nhật trang dữ liệu </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
