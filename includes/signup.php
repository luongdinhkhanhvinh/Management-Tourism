...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<input type="password" value="" placeholder="Mật khẩu" name="password" required="">	
											...
											<p>Bằng cách đăng ký bạn đồng ý với <a href="page.php?type=terms">Điều kiện và điều khoản của chúng tôi</a> and <a href="page.php?type=privacy">Chính sách bảo mật</a></p>
									</div>
								</div>
							</section>
					</div>
